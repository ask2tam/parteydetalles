...
const ScrollDrivenAnimations = {
	...
	mapaEfectos: {
		...
		'Latido de Corazón (Heartbeat)': 'latido-heartbeat', // <-- NUEVO MAPEO
		'Rompecabezas': 'rompecabezas',

		'zoom-rebote': 'zoom-rebote',
		'rotacion-y': 'rotacion-y',
		'volteo-x': 'volteo-x',
		'slide-izquierda': 'slide-izquierda',
		'caida-inercia': 'caida-inercia',
		'glitch-skew': 'glitch-skew',
		'fade-in': 'fade-in',
		'giro-espiral': 'giro-espiral',
		'vibracion': 'vibracion',
		'desenfoque': 'desenfoque',
		'latido-heartbeat': 'latido-heartbeat', // <-- NUEVO MAPEO DIRECTO
		'rompecabezas': 'rompecabezas'
	},
...
ScrollDrivenAnimations.init('PBBmg7trDty216Vq', 'zoom-rebote');
ScrollDrivenAnimations.init('PBQR5W6T7ZkLvJTK', 'Latido de Corazón (Heartbeat)');
ScrollDrivenAnimations.init('PBFchTC9pXQ9hr7F', 'desenfoque');
ScrollDrivenAnimations.init('PBcDcWd57Clb82Xc', 'rotacion-y');
ScrollDrivenAnimations.init('PB9QTSSVmqmQnxp7', 'caida-inercia');
ScrollDrivenAnimations.init('PBQ1xw0sPkbq4xZD', 'glitch-skew');
ScrollDrivenAnimations.init('PBQ0bvgJj4s5KGnS', 'fade-in');
